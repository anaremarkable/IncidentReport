<script>
	$(document).ready(function(){
		$('#modalOpenMd').on('show.bs.modal', function(e){
			...
			if(type=='updStudent'){var link ="php/faculty/student/modal/student_upd.php?student_id="+id;}
			if(type=='updStudStatus'){var link ="php/faculty/student/modal/student_status_update.php?student_id="+id;}
