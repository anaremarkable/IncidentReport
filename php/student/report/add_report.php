        <div style="font-family: verdana;" id="layoutSidenav">
            <div style="font-family: verdana;"  id="layoutSidenav_nav">
                <nav  class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div style="font-family: verdana;" class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    ...
                    <div style="font-family: verdana;" class="sb-sidenav-footer">
                        <div class="small">Logged in as:</div>
                         <?php echo strtoupper($_SESSION['fullname']); ?></b>
                    </div>
                </nav>
            </div>
            <div style="font-family: verdana;" id="layoutSidenav_content">
                <main>
                        ...
                        <div class="row">
                            <form action="sql/submit.php" method="POST" enctype="multipart/form-data">
                                <select name='offense_id'>
                                    ...
                                    <input type="text" name="landmark" placeholder="Place of Happening" ><br>
                                    <br>
                                    Upload Proof of Incident: <br>
                                    <input type ="file" name="report_pic" id="picUpload" onchange="checkImg()">
                                    <br>
                                    <br>
